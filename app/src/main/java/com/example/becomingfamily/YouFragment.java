...
public class YouFragment extends Fragment implements GeminiResponseListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (role.equals("Mom"))
        {
            ...
            prompt= String.format(
                    "ספק הנחיות ממוקדות לבן/בת הזוג (האב) לתמיכה באם בשבוע %d. **חובה לחלק את התשובה לשלושה סעיפים מדויקים באמצעות כותרות בולטות (Markdown headers) בלבד.** " +
                            "שלושת הסעיפים הם:\n" +
                            "1. **תפקידך המרכזי בשבוע זה**: תאר מה הדרך הטובה ביותר לתמוך באמא מבחינה מעשית ורגשית. **השתמש בנקודות בולטות (-).**\n" +
                            "2. **כיצד לתמוך באמא**: ספק רעיונות ספציפיים לתמיכה בתסמינים הנפוצים בשבוע זה (למשל, הקלה על בחילות, הכנת אוכל).\n" +
                            "3. **טיפ זוגי לשבוע זה**: ספק פעילות משותפת קצרה או עצה לחיזוק הקשר הזוגי בשבוע זה.",
                    week);
        }
